...
<!-- contentAwal -->
    <div class="row">
        <div class="col-12"> <a href="{{ route('backend.produk.create') }}"> <button type="button"
                    ...
                    <div class="table-responsive">
                        <table id="zero_config" class="table table-striped table-bordered">
                            ...
                            <tbody> @foreach ($index as $row) <tr>
                                ...
                                <td> @if ($row->status == 1) <span class="badge badge-success"></i> Publis</span>
                                @elseif($row->status == 0) <span class="badge badge-secondary"></i> Blok</span>
                                    @endif </td>
